...
from sg2vid.taming.taming.data.image_transforms import convert_pil_to_tensor
from torch import LongTensor, Tensor

from sg2vid.taming.taming.data.helper_types import BoundingBox, Annotation
from sg2vid.taming.taming.data.conditional_builder.objects_center_points import ObjectsCenterPointsConditionalBuilder
from sg2vid.taming.taming.data.conditional_builder.utils import COLOR_PALETTE, WHITE, GRAY_75, BLACK, additional_parameters_string, \
